...
public class DateTimeAsRelativeDescriptionTest {
    ...
    public void tenSecondsAgo() throws Exception {
		...
		assertEquals("ago-seconds", this.object.getRelativeDescription(messageSource));
	}
	
	@Test
	public void oneMinuteAgo() throws Exception {
		DateTime.setCurrentTimeForTest(2010, 1, 1, 0, 1, 0);
		assertEquals("ago-one-minute", this.object.getRelativeDescription(messageSource));
	}
	...
	public void twoMinutesAgo() throws Exception {
		...
		assertEquals("ago-minutes 2", this.object.getRelativeDescription(messageSource));
	}
	
	@Test
	public void almostOneHourAgo() throws Exception {
		DateTime.setCurrentTimeForTest(2010, 1, 1, 0, 59, 0);
		assertEquals("ago-minutes 59", this.object.getRelativeDescription(messageSource));
	}
	
	@Test
	public void oneHourAgo() throws Exception {
		DateTime.setCurrentTimeForTest(2010, 1, 1, 1, 0, 0);
		assertEquals("ago-one-hour", this.object.getRelativeDescription(messageSource));
	}
	...
	public void twoHoursAgo() throws Exception {
		...
		assertEquals("ago-hours 2", this.object.getRelativeDescription(messageSource));
	}
	
	@Test
	public void almostOneDayAgo() throws Exception {
		DateTime.setCurrentTimeForTest(2010, 1, 1, 23, 0, 0);
		assertEquals("ago-hours 23", this.object.getRelativeDescription(messageSource));
	}
	
	@Test
	public void oneDayAgo() throws Exception {
		DateTime.setCurrentTimeForTest(2010, 1, 2, 0, 0, 0);
		assertEquals("ago-one-day", this.object.getRelativeDescription(messageSource));
	}
	...
	public void twoDaysAgo() throws Exception {
		...
		assertEquals("ago-days 2", this.object.getRelativeDescription(messageSource));
	}
	
	@Test
	public void almostOneMonthAgo() throws Exception {
		DateTime.setCurrentTimeForTest(this.object.addDays(29));
		assertEquals("ago-days 29", this.object.getRelativeDescription(messageSource));
	}
	
	@Test
	public void oneMonthAgo() throws Exception {
		DateTime.setCurrentTimeForTest(this.object.addDays(30));
		assertEquals("ago-one-month", this.object.getRelativeDescription(messageSource));
	}
	...
	public void twoMonthsAgo() throws Exception {
		...
		assertEquals("ago-months 2", this.object.getRelativeDescription(messageSource));
	}
	
	@Test
	public void almostOneYearAgo() throws Exception {
		DateTime.setCurrentTimeForTest(this.object.addDays(364));
		assertEquals("ago-months 12", this.object.getRelativeDescription(messageSource));
	}
	
	@Test
	public void oneYearAgo() throws Exception {
		DateTime.setCurrentTimeForTest(this.object.addDays(365));
		assertEquals("ago-one-year", this.object.getRelativeDescription(messageSource));
	}
	...
	public void twoYearsAgo() throws Exception {
		...
		assertEquals("ago-years 2", this.object.getRelativeDescription(messageSource));
	}
}
