...
public class MonthTest {
	...
	public void test2005_10_04() throws Exception {
		...
		assertEquals("2005-10-01 00:00:00.0", start.format("yyyy-MM-dd HH:mm:ss.S"));

		DateTime end = month.getEndInstant();
		assertEquals("2005-10-31 23:59:59.999", end.format("yyyy-MM-dd HH:mm:ss.S"));
	...
	public void test2005_12_25() throws Exception {
		...
		DateTime start = month.getStartInstant();
		assertEquals("2005-12-01 00:00:00.0", start.format("yyyy-MM-dd HH:mm:ss.S"));

		DateTime end = month.getEndInstant();
		assertEquals("2005-12-31 23:59:59.999", end.format("yyyy-MM-dd HH:mm:ss.S"));
