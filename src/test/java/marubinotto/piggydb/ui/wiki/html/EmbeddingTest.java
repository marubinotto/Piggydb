...
public class EmbeddingTest extends HtmlBuilderTestBase {
	...
	public void embedFileFragment() throws Exception {
		...
		assertEquals(
			"<img src=\"/images/file-icons/default.png\"" +
				...
				" <span><a href=\"/command/get-file.htm?id=123\">file.txt</a>" +
	...
	public void embedImageFragment() throws Exception {
		...
		// Then
		assertEquals(
			"<a class=\"img-link\" href=\"/command/get-file.htm?id=123\">" +
				"<img class=\"fragment-img\" src=\"/command/get-file.htm?id=123\"" +
				" border=\"0\" alt=\"\"/></a>", 
			result);
	}
