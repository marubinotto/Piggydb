...
public class TagTree extends Tree {
	...
	public TagTree(String name, WebResources webResources, HtmlFragments htmlFragments) {
		super(name);
	...
	@Override
	protected void renderTreeNodeStart(
			...
			public String render(Object object, Context context) {
		        ...
		        if (treeNode instanceof FirstLevelNode) {
		        	...
		        	if (firstLevelNode.removable) {
			        	...
			        	buffer.append(StringEscapeUtils.escapeHtml(
	...
	protected void renderIcon(HtmlStringBuffer buffer, TreeNode treeNode) {
        ...
        buffer.appendAttribute(
        	"class", this.htmlFragments.tagIconClass((String)treeNode.getValue()));
        buffer.append(">");
	}
    ...
    protected void renderValue(HtmlStringBuffer buffer, TreeNode treeNode) {
        ...
        buffer.appendAttribute("href", this.webResources.tagPath(getTagId(treeNode)));
        buffer.closeTag();
	...
	@Override
	protected void renderTreeNodeEnd(
		HtmlStringBuffer buffer, 
		TreeNode treeNode,
        int indentation) {
...
// Utilities
	...
	/**
	 * Removabilities of first level tags will be the same as the parameter "removable".
	 */
	...
	/**
	 * Removability of each first level tag will be set respectively via Classifiable#canRemoveTag.
	 */
