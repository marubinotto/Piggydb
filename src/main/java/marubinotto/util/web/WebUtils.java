...
public class WebUtils {
    ...
    private static void appendQueryEntry(
    	String key, 
    	String value, 
    	String encoding, 
    	StringBuilder qs) 
    ...
    public static int[] getMsieVersion(HttpServletRequest request) {
    	...
    	String version = userAgent.substring(
    		beginIndex + UA_MSIE.length(), 	// Mozilla/4.0 (compatible; MSIE X.X
    		endIndex);
    ...
    throws UnsupportedEncodingException {
    	...
    	if (request.getMethod().equalsIgnoreCase("GET") &&
    		serverInfo.toLowerCase().indexOf("tomcat") != -1) {
